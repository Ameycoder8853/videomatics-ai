    ...
    try {
      ...
      const imageUploadPromises = localImageUris.map((uri, index) => {
        if (uri.startsWith('data:image')) {
          // This is a base64-encoded image generated by the AI, upload it.
          return uploadDataUriToStorage(uri, `videos/${user.uid}/${videoId}/image_${index}.png`);
        }
        // This is a placeholder URL (e.g., from placehold.co), use it directly.
      ...
      const videoToSave: Partial<VideoDocument> = {
        ...
        imageUris: imageDownloadUrls, // Store download URLs (or placeholder URLs)
